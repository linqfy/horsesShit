...
class User(Base):
    ...
    def update_total_balance(self):
        """
        Actualiza el balance total del usuario sumando los balances de todos los HorseBuyers.
        """
        self.balance = sum(
            buyer.balance for buyer in self.horses_buying if not buyer.horse.is_deleted
        )
